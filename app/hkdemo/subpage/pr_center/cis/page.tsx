                ...
                <div className={'w-full flex flex-col mt-10 md:mt-0 items-start md:col-span-2'}>
                    <div className={'flex flex-col w-full'}>
                        ...
                        <div className={'flex flex-col gap-y-3 items-end w-full pt-10'}>
                            <div
                                className={'w-[90%] rounded-br-lg rounded-tl-lg bg-hkred text-white pl-10 py-2 font-semibold text-xl'}>
                                HK RED
                            </div>
                        ...
                        <div className={'flex flex-col gap-y-3 items-end w-full pt-10'}>
                            <div
                                className={'w-[90%] rounded-br-lg rounded-tl-lg bg-hkcyan text-white pl-10 py-2 font-semibold text-xl'}>
                                HK CYAN
                            </div>
                            <div className={'w-[85%] flex justify-start'}>
                                <ul className={'list-disc'}>
                        ...
                        <div className={'flex flex-col gap-y-3 items-end w-full pt-10'}>
                            <div
                                className={'w-[90%] rounded-br-lg rounded-tl-lg bg-hkivory text-white pl-10 py-2 font-semibold text-xl'}>
                                HK IVORY
                            </div>
                            <div className={'w-[85%] flex justify-start'}>
                                <ul className={'list-disc'}>
                        ...
                        <div className={'flex flex-col gap-y-3 items-end w-full pt-10'}>
                            <div
                                className={'w-[90%] rounded-br-lg rounded-tl-lg bg-hkdarkblue text-white pl-10 py-2 font-semibold text-xl'}>
                                HK BLUE
                            </div>
                            <div className={'w-[85%] flex justify-start'}>
                                <ul className={'list-disc'}>
