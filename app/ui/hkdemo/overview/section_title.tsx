...
function TitleIcon() {
    return (
        <div className={'flex relative'}>
            <div
                className={'flex items-center justify-center border-4 border-red-600 w-5 h-5 sm:w-6 sm:h-6 rounded-br-lg rounded-tl-lg'}>
                <div className={'w-3 h-3 sm:w-4 sm:h-4 rounded-br-sm rounded-tl-sm'}></div>
            </div>
        </div>
    );
}