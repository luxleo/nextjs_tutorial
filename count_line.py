...
# 조사할 디렉토리 경로
ROOT_DIR = '\\Users\\5600G\\Desktop\\practice\\next js\\nextjs_docs_tutorial\\nextjs-dashboard'
...
# 무시할 디렉토리 경로 목록
ignore_paths = [
    '\\Users\\5600G\\Desktop\\practice\\next js\\nextjs_docs_tutorial\\nextjs-dashboard\\node_modules',
    '\\Users\\5600G\\Desktop\\practice\\next js\\nextjs_docs_tutorial\\nextjs-dashboard\\.next'
]
...
def start_count():
    ...
    for file_name_with_path in files_grabbed:
        ...
        line_count = sum(1 for line in open(file_name_with_path, encoding='UTF-8'))
